...
class MovieSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $movies = [
            ...
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Objektiv Močvare', 'director' => 'Nemanja Petrović', 'description' => $descriptions[1], 'banner_url' => 'mocvare_banner.png', 'image_url' => 'mocvare.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 200, 'is_showcased' => 1, 'genre_id' => 5],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Eho Gneva', 'director' => 'Danica Jovanović', 'description' => $descriptions[2], 'banner_url' => 'pobuna_banner.png', 'image_url' => 'pobuna.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 180, 'is_showcased' => 1, 'genre_id' => 4],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Nebeske Kule', 'director' => 'Luka Novaković', 'description' => $descriptions[3], 'banner_url' => 'tesseract_banner.png', 'image_url' => 'tesseract.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 130, 'is_showcased' => 0, 'genre_id' => 6],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Albatros', 'director' => 'Miroslav Popović', 'description' => $descriptions[4], 'banner_url' => 'topgan_banner.png', 'image_url' => 'topgan.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 160, 'is_showcased' => 1, 'genre_id' => 1],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Spartanski Duh', 'director' => 'Isidora Nikolić', 'description' => $descriptions[5], 'banner_url' => 'troja_banner.png', 'image_url' => 'troja.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 140, 'is_showcased' => 0, 'genre_id' => 1],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Zvuk Planine', 'director' => 'Milica Đorđević', 'description' => $descriptions[6], 'banner_url' => 'alpi_banner.png', 'image_url' => 'alpi.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 180, 'is_showcased' => 0, 'genre_id' => 5],
            ['created_at' => now(), 'updated_at' => now(), 'title' => 'Niti Budućnosti', 'director' => 'Marko Vasić', 'description' => $descriptions[7], 'banner_url' => 'deus_ex_banner.png', 'image_url' => 'deus_ex.png', 'trailer_url' => 'https://youtube.com', 'release_date' => fake()->dateTimeBetween('-3 years'), 'duration' => 120, 'is_showcased' => 1, 'genre_id' => 6],
