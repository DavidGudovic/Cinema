<nav class="sticky top-0 bg-white text-black z-50 p-4">
    <ul class="flex justify-around">
        <li class="hover:underline hover:text-red-600 hover:cursor-pointer">Pocetna</li>
        ...
        @guest
        <li class="hover:underline hover:text-red-600 hover:cursor-pointer">Uloguj se</li>
        <li class="hover:underline hover:text-red-600 hover:cursor-pointer">Registracija</li>
        @else
        <li class="hover:underline hover:text-red-600 hover:cursor-pointer">Profil</li>
        <li class="hover:underline hover:text-red-600 hover:cursor-pointer">Odjavi se</li>
        @endguest
    </ul>
</nav>
