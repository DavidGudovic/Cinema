<nav class="sticky top-0 bg-white text-black z-40 p-4">
    <ul class="flex justify-around">
        <li class="hover:underline hover:text-red-500">Pocetna</li>
        <li class="hover:underline hover:text-red-500">Projekcije</li>
        <li class="flex items-center">
            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 249 251">
        ...
        @guest
        <li class="hover:underline hover:text-red-500">Uloguj se</li>
        <li class="hover:underline hover:text-red-500">Registracija</li>
        @else
        <li class="hover:underline hover:text-red-500">Profil</li>
        <li class="hover:underline hover:text-red-500">Odjavi se</li>
        @endguest
    </ul>
</nav>
