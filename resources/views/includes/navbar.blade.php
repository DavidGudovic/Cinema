<nav x-data="{showNavbar: false}" x-breakpoint="if($isBreakpoint('md+')) showNavbar = true"
     class="sticky w-full top-0 backdrop-blur-sm bg-gray-950 bg-opacity-60 hover:bg-opacity-100 hover:border-b hover:border-white text-white z-50 p-4 min-h-[2rem] md:h-auto ">
    <!-- Hamburger -->
        ...
        <div class="flex-1 flex justify-center items-center">
            ...
            <div class="flex-1 flex justify-center items-center">
                <div x-data="{ business_open: false }" x-on:click.outside="business_open = false">
                    ...
                    <!-- hidden menu -->
                    <ul class="absolute flex flex-col gap-4 rounded-lg backdrop-blur-sm bg-gray-950 md:bg-opacity-60 hover:bg-opacity-100 hover:border hover:border-white text-white  p-4 mt-4 "
