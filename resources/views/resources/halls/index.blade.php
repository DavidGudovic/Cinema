        ...
        <div x-data='{duration: 1, hour: 8, date: "{{ \Carbon\Carbon::now()->format('Y-m-d') }}" }' class="flex flex-col md:flex-row gap-6 rounded-xl bg-neutral-200 p-2 px-4">
            ...
            <div class="flex gap-6">
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <input type="date"  x-model="date" min="{{ \Carbon\Carbon::now()->format('Y-m-d') }}" max="{{ \Carbon\Carbon::now()->addMonths(2)->format('Y-m-d') }}"  x-on:keydown="return false;" class="rounded-md border text-neutral-700 border-neutral-700 p-1">
                </div>
                <!-- end datum -->
                <!-- StartTime -->
                <div class="flex flex-col gap-1">
