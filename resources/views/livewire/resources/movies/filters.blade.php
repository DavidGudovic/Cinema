<div x-data="{ showFilters: true, showSearchBar: false }">
  ...
  <!-- Search -->
    ...
    <!-- Closed search icons-->
  <button class="fixed top-20 right-6 pt-2 hover:text-red-700 text-white" type="button"
  ...
  <form wire:submit.prevent="search" x-cloak class="text-white">
    <!-- Search Submit-->
    <button class="fixed top-20 right-6 pt-2 hover:text-red-700 z-10" type="submit"
    ...
    <!-- End search submit -->
      ...
      <a href="" class="fa-solid fa-arrow-right fa-2xl fixed top-24 pt-2 right-72"
       ...
       <input type="text" name="searchBar" placeholder="Film, Režiser ili Žanr"
           ...
           class="fixed top-20 right-4 bg-gray-950 bg-opacity-75 border-2 border-gray-200 rounded-3xl p-2 w-64">
      <!-- End search bar -->
  </form>
  <!-- End search open -->
  <!--End Search -->
  ...
  <form wire:submit.prevent="submit" class="flex flex-col gap-4 border-2 border-gray-800 bg-gray-950 bg-opacity-75 p-6 min-w-[250px] text-white"
    ...
    <div class="flex flex-col ">
      <p class="text-opacity-70 text-sm">Beletristika</p>
    ...
    <!--NonFiction-->
    <div class="flex flex-col ">
      <p class="text-opacity-70 text-sm">Popularna nauka</p>
    ...
    <div class="flex flex-col gap-2">
      <p class="text-opacity-70 text-sm">Maksimalna cena</p>
